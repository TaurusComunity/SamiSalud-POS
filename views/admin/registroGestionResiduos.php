<?php
$user = $this->data['user'];
$GestionResiduos = $this->data['GestionResiduos'];
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <title>Gestion Residuos | CC</title>
</head>
...
<body class="bg-blanco flex  w-full absolute min-h-[100vh]">
    ...
    <section id="contenido" class="flex flex-col  bg-azul_oscuro_opacidad w-[60%] relative rounded-3xl my-5">
        <article class="w-full pt-5 px-8">
            <h2 class="text-azul_oscuro text-[32px] font-semibold">Gestion Residuos</h2>
        ...
        <main class="px-5 pt-10">
            ...
            <?php include 'views/partials/getGestionResiduos.php'; ?>
            <?php include 'views/partials/modalGestionResiduos.php'; ?>
