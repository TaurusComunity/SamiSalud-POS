<?php
$user = $this->data['user'];
$consolidado_faltantes = $this->data['consolidado_faltantes'];
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <title>Consolidado faltantes | CC</title>
</head>
...
<body class="bg-blanco flex  w-full absolute min-h-[100vh]">
    ...
    <section id="contenido" class="flex flex-col  bg-azul_oscuro_opacidad w-[60%] relative rounded-3xl my-5">
        <article class="w-full pt-5 px-8">
            <h2 class="text-azul_oscuro text-[32px] font-semibold">Consolidado Faltantes</h2>
        ...
        <main class="px-5 pt-10">
            <div class="flex justify-between items-center">
                ...
                <div class="flex items-center justify-center gap-5">
                    ...
                    <div class="group relative inline-block cursor-pointer"
                        onclick="document.getElementById('myModalConsolidado').showModal()" id="btn>
                        <button class=" focus:outline-none">
                        <svg class="bi bi-instagram transform transition-transform duration-300 hover:scale-125 hover:text-blue-500"
                            fill="currentColor" height="30" width="30" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 512 512">
            ...
            <?php include 'views/partials/getConsolidadodFaltantes_form.php'; ?>
            <?php include 'views/partials/modalConsolidadoFaltantes.php'; ?>
