<?php
$user = $this->data['user'];
$limpiezaDrogueria = $this->data['limpiezaDrogueria'];
?>
<!DOCTYPE html>
<html lang="es">
...
<head>
    ...
    <link
        ...
        rel="stylesheet">
    <title>Limpieza Drogueria | CC</title>
</head>
...
<body class="bg-blanco flex  w-full absolute min-h-[100vh]">
    ...
    <section id="contenido" class="flex flex-col  bg-azul_oscuro_opacidad w-[60%] relative rounded-3xl my-5">
        <article class="w-full pt-5 px-8">
            <h2 class="text-azul_oscuro text-[32px] font-semibold">Limpieza de Drogueria</h2>
        ...
        <main class="px-5 pt-10">
            ...
            <?php include 'views/partials/getLimpiezaDrogueria_form.php'; ?>
            <?php include 'views/partials/modalLimpiezaDrogueria.php'; ?>
