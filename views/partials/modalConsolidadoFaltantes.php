<dialog id="myModalConsolidado" class="h-[35%] w-11/12 p-5 bg-white rounded-md ">
...
<div class="flex flex-col w-full h-full ">
    ...
    <div class="flex w-full h-auto justify-center items-center">
        ...
        <div onclick="document.getElementById('myModalConsolidado').close();"
    ...
    <div class="mt-5">
        <form action="<?php echo constant('URL'); ?>/consolidadoFaltantes/newConsolidado" method="post">
                ...
                <div class="w-full h-12 flex gap-2">
                    <div class="w-full h-12 relative flex rounded-xl">
                        <input required=""
                            ...
                            id="id" type="text" name="cantidad_ingresada" />
                        <label
            ...
            <div class="w-full h-full gap-2 flex flex-col">
                ...
                <div class="flex justify-center gap-5 mt-2">
                    ...
                    <button onclick="document.getElementById('myModalConsolidado').close();"
