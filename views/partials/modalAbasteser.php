<dialog id="myModalAbastecer" class="h-[75%] w-11/12 p-5 bg-white rounded-md ">
    ...
    <div class="flex flex-col w-full h-full ">
        ...
        <!-- Modal Content-->
        <div>
            <p>Verifica y edita los campos <span class="text-azul font-bold">CUIDADOSAMENTE</span> para obtener una
                actulización del producto éxitosamente.</p>
        </div>
        ...
        <div class="mt-5">
            <form action="<?php echo constant('URL'); ?>/products/updateProduct" method="post" id="precioForm">
                <div class="w-full h-full gap-2 flex flex-col">
                    <div class="w-full h-12 flex gap-2">
                        <div class="w-full h-12 relative flex rounded-xl">
                            <input required=""
                                ...
                                value="<?php echo $product['codigo_barras'] ?>" />
                            <label
                        ...
                        <div class="w-full h-12 relative flex rounded-xl">
                            <input required=""
                                class="peer w-full bg-transparent outline-none px-4 text-base rounded-xl bg-white border border-[#4070f4] focus:shadow-md"
                                id="stock" type="number" name="stock" value="<?php echo $product['stock'] ?>" min="0" />
                            <label
                                class="absolute top-1/2 translate-y-[-50%] bg-white left-4 px-2 peer-focus:top-0 peer-focus:left-3 font-light text-base peer-focus:text-sm peer-focus:text-[#4070f4] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm peer-valid:text-[#4070f4] duration-150"
                                for="stock">
                    ...
                    <div class="w-full h-12 flex gap-2">
                        <div class="w-full h-12 relative flex rounded-xl">
                            <input required=""
                                ...
                                value="<?php echo $product['precio_neto'] ?>" />
                            <label
                                class="absolute top-1/2 translate-y-[-50%] bg-white left-4 px-2 peer-focus:top-0 peer-focus:left-3 font-light text-base peer-focus:text-sm peer-focus:text-[#4070f4] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm peer-valid:text-[#4070f4] duration-150"
                                for="precio_neto">
                                Precio Neto</label>
                    ...
                    <br>
                    <div>
                        <p>Llena los campos <span class="text-azul font-bold">REQUERIDOS NUEVAMENTE</span> del campo:
                            Fecha de vencimiento, Lote, Registro Sanitario para obtener un registro ya verificado.</p>
                    </div>
                    <!-- End of Modal Content-->
                    ...
                    <div class="mt-5">
                        <div class="w-full h-full gap-2 flex flex-col">
                            <div class="w-full h-12 flex gap-2">
                                <div class="w-full h-12 relative flex rounded-xl">
                                    <input required=""
                                        class="peer w-full bg-transparent outline-none px-4 text-base rounded-xl bg-white border border-[#4070f4] focus:shadow-md"
                                        id="id" type="number" name="codigo_barras"
                                        value="<?php echo $productInfo['codigo_barras'] ?>" />
                                    <label
                                        class="absolute top-1/2 translate-y-[-50%] bg-white left-4 px-2 peer-focus:top-0 peer-focus:left-3 font-light text-base peer-focus:text-sm peer-focus:text-[#4070f4] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm peer-valid:text-[#4070f4] duration-150"
                                        for="id">
                                        Código de barras</label>
                                ...
                                <div class="w-full h-12 relative flex rounded-xl">
                                    <input required=""
                                        ...
                                        value="<?php echo $productInfo['fechaVencimiento'] ?>" />
                                    <label
                                        class="absolute top-1/2 translate-y-[-50%] bg-white left-4 px-2 peer-focus:top-0 peer-focus:left-3 font-light text-base peer-focus:text-sm peer-focus:text-[#4070f4] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm peer-valid:text-[#4070f4] duration-150"
                                        for="vencimiento">
                            ...
                            <div class="w-full h-12 flex gap-2">
                                <div class="w-full h-12 relative flex rounded-xl">
                                    <input
                                        ...
                                        value="<?php echo $productInfo['registroSanitario'] ?>" />
                                    <label
                                        class="absolute top-1/2 translate-y-[-50%] bg-white left-4 px-2 peer-focus:top-0 peer-focus:left-3 font-light text-base peer-focus:text-sm peer-focus:text-[#4070f4] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm peer-valid:text-[#4070f4] duration-150"
                                ...
                                <div class="w-full h-12 relative flex rounded-xl">
                                    <input
                                        ...
                                        value="<?php echo $productInfo['distribuidor'] ?>" />
                                    <label
                                        class="absolute top-1/2 translate-y-[-50%] bg-white left-4 px-2 peer-focus:top-0 peer-focus:left-3 font-light text-base peer-focus:text-sm peer-focus:text-[#4070f4] peer-valid:-top-0 peer-valid:left-3 peer-valid:text-sm peer-valid:text-[#4070f4] duration-150"
                                        for="proveedor">
                                        Proveedor</label>
                            ...
                            <div class="flex justify-center gap-5 mt-2">
                                ...
                                <p onclick="document.getElementById('myModalAbastecer').close();"
